...
parser.add_argument('--data_id', type=str, default='FD001', help='dataset id for paired train/test csv')
parser.add_argument('--time_col_name', type=str, default='Cycle', help='time column name for custom csv')
parser.add_argument('--unit_col_name', type=str, default='UnitNumber', help='unit column name for custom csv')
